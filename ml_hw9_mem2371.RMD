...
table.1 = tableby(~ behav + hs_no2_wk_hs_h_log + h_pm_log +
...
The outcome that I am choosing to explore is related to neuro-behavior, and internalizing/externalizing behaviors at 6-11 years old via the CBCL scale. I have dichotomized the scale at 60, which is a value used in previous research for identifying clinically relevant psychopathology (Biederman et al., 2010).
...
Given available data, and the number of features, my research question of interest will be hypothesis generating. This analysis will aim to determine potential risk factors of internalizing/externalizing behaviors at 6-11 years old, assessed via the CBCL scale.
